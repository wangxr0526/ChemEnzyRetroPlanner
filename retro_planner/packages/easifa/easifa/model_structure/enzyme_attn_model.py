...
from easifa.model_structure.esm_layer import EvolutionaryScaleModeling as ESM
...
if __name__ == '__main__':
    ...
    from easifa.data_loaders.enzyme_dataloader import EnzymeDataset, enzyme_dataset_graph_collate
