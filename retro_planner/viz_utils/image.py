...
class GraphvizReactionGraph:
    ...
    def __init__(self):
        ...
        self._molecules = []
        self._molecule_tmpfname = []
        self._molecule_fcolor = []
    ...
    def add_molecule(self, molecule, frame_color):
        ...
        self._molecule_fcolor.append(frame_color)
        self._molecule_tmpfname.append(filename)
    ...
    def to_image(self):
        ...
        :rtype: PIL.Image
        """
        for molecule, fname, frame_color in zip(self._molecules, self._molecule_tmpfname, self._molecule_fcolor):
            img = molecule_to_image(molecule, frame_color=frame_color)
            img.save(fname)
    ...
    def to_imagefile(self,fname):
        ...
        # _, output_img = tempfile.mkstemp(suffix=".img")
        subprocess.call([f"neato{ext}", "-T", "png", f"-o{fname}", output_dot])
